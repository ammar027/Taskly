...
import { View, Text, TextInput, Pressable, ScrollView, Alert, ActivityIndicator, RefreshControl, Platform } from 'react-native';
...
import styles from '../../styles/NoteDetailStyles';
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDarkMode ? '#1a1a1a' : '#FFFFFF' }]}>
      ...
      <ScrollView 
        ...
        refreshControl={
          <RefreshControl 
            refreshing={isLoading && !isEditing} 
            onRefresh={handleRefresh} 
            colors={['#4F46E5']} 
      ...
      >
          ...
          <View style={styles.metadataContainer}>
            {note.dueDate && (
              <View style={styles.metadataItem}>
                ...
                <Text style={[styles.metadataText, { color: isDarkMode ? '#9ca3af' : '#64748B' }]}>
            ...
            {note.priority && (
              <View style={styles.metadataItem}>
                <Ionicons name="flag-outline" size={14} color={
            ...
            {note.reminder && (
              <View style={styles.metadataItem}>
                ...
                <Text style={[styles.metadataText, { color: isDarkMode ? '#9ca3af' : '#64748B' }]}>
                  Reminder: {typeof note.reminder === 'string' ? note.reminder : new Date(note.reminder).toLocaleString()}
                </Text>
              </View>
            )}
          </View>
        ...
        {isEditing ? (
          ...
          <Text style={[styles.contentText, { color: isDarkMode ? '#d1d5db' : '#334155' }]}>
